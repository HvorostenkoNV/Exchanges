...
abstract class QueueDataClass extends ExchangeTestCase
{
	 ...
	 * check empty object
	 * @test
	 * @return  Queue                   empty Queue data
	 ************************************************************************/
	public function emptyObject() : Queue
	{
	 ...
	 * @test
	 * @depends emptyObject
	 * @param   Queue   $queue          empty   Queue data
	 * @return  Queue                   filled  Queue data
	 ************************************************************************/
	public function readWriteOperations(Queue $queue) : Queue
	{
	 ...
	 * @param   Queue   $queue          empty Queue data
	 ************************************************************************/
	public function incorrectReadWriteOperations(Queue $queue) : void
	{
	 ...
	 * @param   Queue   $queue          filled Queue data
	 ************************************************************************/
	public function clearingOperations(Queue $queue) : void
	{
		$queue->clear();
